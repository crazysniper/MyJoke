...
public class ActivityFragment extends BaseFragment {
    ...
    public void updateView(FragmentEvent fragmentEvent) {
        LogUtil.e("ActivityFragment updateView " + fragmentEvent);
        if (fragmentEvent != null && "message".equals(fragmentEvent.getType())) {
            LogUtil.e("ActivityFragment msg=" + fragmentEvent.getMsg());
