...
import application.webviewdemo.util.X5WebView;
...
public class BrowserActivity extends Activity {
    ...
    private void init() {
        ...
        LogUtil.e("是否加载了x5内核==" + mWebView.getX5WebViewExtension());
    }
    ...
    private void initBtnListenser() {
        ...
        mUrl.setText("http://soft.imtt.qq.com/browser/tes/feedback.html");
