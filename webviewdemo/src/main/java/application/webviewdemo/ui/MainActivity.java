...
@Route(path = WebViewConstant.MainActivity)
public class MainActivity extends Activity {
    ...
    private void new_init() {
        ...
        this.gridAdapter = new SimpleAdapter(this, items, R.layout.function_block, new String[]{"title", "icon"}, new int[]{R.id.Item_text, R.id.Item_bt});
